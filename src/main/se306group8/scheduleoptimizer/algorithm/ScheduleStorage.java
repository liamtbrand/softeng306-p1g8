...
public class ScheduleStorage {
	...
	public void storeSchedule(PartialSchedule schedule) {
		assert false : "Not done";
	}
	
	/** Stores a list of schedules in storage. */
	public void storeSchedules(Collection<PartialSchedule> schedules) {
		for(PartialSchedule partial : schedules) {
